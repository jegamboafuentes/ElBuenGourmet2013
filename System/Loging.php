...
if (isset($_POST['user'])) {
  ...
  $MM_redirectLoginSuccess = "menuAdmin.php";
  $MM_redirectLoginFailed = "Loging.php";
  $MM_redirecttoReferrer = true;
  mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
  	
  $LoginRS__query=sprintf("SELECT id_user, password, tipo FROM usuarios WHERE id_user=%s AND password=%s",
...
<div class="container">
  <div class="header"><img src="Img/logox.jpg" width="243" height="114" /><!-- end .header --></div>
  <div class="content">
    <h1>Loging</h1>
