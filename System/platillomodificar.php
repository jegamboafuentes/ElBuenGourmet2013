...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO platillo (id_plat, nombre_plat, precio, tipo, descripcion_plat, imagen_plat) VALUES (%s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['imagen_plat'], "text"));

  mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
  $Result1 = mysql_query($insertSQL, $COnexionGourmet) or die(mysql_error());
}

$colname_RecordsetPlatilloEditar = "-1";
if (isset($_GET['id'])) {
  $colname_RecordsetPlatilloEditar = $_GET['id'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_RecordsetPlatilloEditar = sprintf("SELECT * FROM menu WHERE id_menu = %s", GetSQLValueString($colname_RecordsetPlatilloEditar, "int"));
$RecordsetPlatilloEditar = mysql_query($query_RecordsetPlatilloEditar, $COnexionGourmet) or die(mysql_error());
$row_RecordsetPlatilloEditar = mysql_fetch_assoc($RecordsetPlatilloEditar);
$totalRows_RecordsetPlatilloEditar = mysql_num_rows($RecordsetPlatilloEditar);
?>
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Id_plat:</td>
          <td><input type="text" name="id_plat" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Nombre_plat:</td>
          <td><input type="text" name="nombre_plat" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><select name="tipo">
            <option value="comida" <?php if (!(strcmp("comida", ""))) {echo "SELECTED";} ?>>Comida</option>
            <option value="bebida" <?php if (!(strcmp("bebida", ""))) {echo "SELECTED";} ?>>Bebida</option>
            <option value="postre" <?php if (!(strcmp("postre", ""))) {echo "SELECTED";} ?>>Postre</option>
            <option value="ensalada" <?php if (!(strcmp("ensalada", ""))) {echo "SELECTED";} ?>>Ensalada</option>
            <option value="x" <?php if (!(strcmp("x", ""))) {echo "SELECTED";} ?>>Otro</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Descripcion_plat:</td>
          <td><input type="text" name="descripcion_plat" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Imagen_plat:</td>
          <td><input type="text" name="imagen_plat" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RecordsetPlatilloEditar);
?>
