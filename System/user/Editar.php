...
$colname_id_menu = "-1";
if (isset($_GET['fecha'])) {
  $colname_id_menu = $_GET['fecha'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_id_menu = sprintf("SELECT id_menu FROM menu WHERE fecha = %s", GetSQLValueString($colname_id_menu, "text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Sopas = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre, platillo.precio FROM platillo, detalle_menu, menu WHERE detalle_menu.id_plat = platillo.id_plat and detalle_menu.id_menu = menu.id_menu and platillo.tipo='Sopa' and menu.id_menu = %s ",GetSQLValueString($row_id_menu['id_menu'], "int"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Ensaladas = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre, platillo.precio FROM platillo, detalle_menu, menu WHERE detalle_menu.id_plat = platillo.id_plat and detalle_menu.id_menu = menu.id_menu and platillo.tipo='Ensalada' and menu.id_menu = %s ",GetSQLValueString($row_id_menu['id_menu'], "text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Antojitos = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre, platillo.precio FROM platillo, detalle_menu, menu WHERE detalle_menu.id_plat = platillo.id_plat and detalle_menu.id_menu = menu.id_menu and platillo.tipo='Antojito' and menu.id_menu = %s ",GetSQLValueString($row_id_menu['id_menu'], "text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Guisados = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre, platillo.precio FROM platillo, detalle_menu, menu WHERE detalle_menu.id_plat = platillo.id_plat and detalle_menu.id_menu = menu.id_menu and platillo.tipo='Guisado' and menu.id_menu = %s ",GetSQLValueString($row_id_menu['id_menu'], "text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Postres = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre, platillo.precio FROM platillo, detalle_menu, menu WHERE detalle_menu.id_plat = platillo.id_plat and detalle_menu.id_menu = menu.id_menu and platillo.tipo='Postre' and menu.id_menu = %s ",GetSQLValueString($row_id_menu['id_menu'], "text"));
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    <h1>Revision del menu 
      <label for="id_menu"></label>
      <input name="id_menu" type="hidden" id="id_menu" value="<?php echo $row_id_menu['id_menu']; ?>" />
    </h1>
    <div align="right">
      <table width="200" border="1">
        <tr>
          <td><div align="center"><a href="menuMenuUser.php">Salir</a></div></td>
        </tr>
      </table>
    </div>
    <div align="center">
      <table width="200" border="0">
        <tr>
          <td>Sopas</td>
          <td><a href="../Templates/Menu/Menu 2.0/paso 1 link.php"><img src="../Img/mas.png" width="35" height="35" alt="Insertar" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;
            <table border="1">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="../Templates/Menu/Menu 2.0/Elimina fin.php?id_plat=<?php echo $row_Sopas['id_plat']; ?>&amp;id_menu=<?php echo                                                                   $row_Sopas['id_menu']; ?>""><img src="../Img/eliminar-icono-4790-96.png" width="35" height="35" alt="Elminar" /></a></td>
                </tr>
        ...
        <tr>
          <td>Ensaladas</td>
          <td><a href="../Templates/Menu/Menu 2.0/Paso 2/paso 2 link.php"><img src="../Img/mas.png" width="35" height="35" alt="Insertar" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;
            <table border="1">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="../Templates/Menu/Menu 2.0/Elimina fin.php?id_plat=<?php echo $row_Ensaladas['id_plat']; ?>&amp;id_menu=<?php echo                                                                   $row_Ensaladas['id_menu']; ?>""><img src="../Img/eliminar-icono-4790-96.png" width="35" height="35" alt="Elminar" /></a><a href="../Templates/Menu/Menu 2.0/Elimina fin.php"></a></td>
                </tr>
        ...
        <tr>
          <td>Antojitos</td>
          <td><a href="../Templates/Menu/Menu 2.0/Paso 3/paso 3 link.php"><img src="../Img/mas.png" width="35" height="35" alt="Insertar" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;
            <table border="1">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="../Templates/Menu/Menu 2.0/Elimina fin.php?id_plat=<?php echo $row_Antojitos['id_plat']; ?>&amp;id_menu=<?php echo                                                                   $row_Antojitos['id_menu']; ?>""><img src="../Img/eliminar-icono-4790-96.png" width="35" height="35" alt="Elminar" /></a><a href="../Templates/Menu/Menu 2.0/Elimina fin.php"></a></td>
                </tr>
        ...
        <tr>
          <td>Guisados</td>
          <td><a href="../Templates/Menu/Menu 2.0/Paso 4/paso 4 link.php"><img src="../Img/mas.png" width="35" height="35" alt="Insertar" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;
            <table border="1">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="../Templates/Menu/Menu 2.0/Elimina fin.php?id_plat=<?php echo $row_Guisados['id_plat']; ?>&amp;id_menu=<?php echo                                                                   $row_Guisados['id_menu']; ?>""><img src="../Img/eliminar-icono-4790-96.png" width="35" height="35" alt="Elminar" /></a><a href="../Templates/Menu/Menu 2.0/Elimina fin.php"></a></td>
                </tr>
        ...
        <tr>
          <td>Postres</td>
          <td><a href="../Templates/Menu/Menu 2.0/Paso 5/paso 5 link.php"><img src="../Img/mas.png" width="35" height="35" alt="Insertar" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;
            <table border="1">
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td><a href="../Templates/Menu/Menu 2.0/Elimina fin.php?id_plat=<?php echo $row_Postres['id_plat']; ?>&amp;id_menu=<?php echo                                                                   $row_Postres['id_menu']; ?>""><img src="../Img/eliminar-icono-4790-96.png" width="35" height="35" alt="Elminar" /></a><a href="../Templates/Menu/Menu 2.0/Elimina fin.php"></a></td>
                </tr>
