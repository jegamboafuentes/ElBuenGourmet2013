...
<style type="text/css">
.blue {background-color: #099; }
.button {	background: #222 url(http://sites.google.com/site/zavaletaster/Home/overlay.png) repeat-x;
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion3" -->
    <div align="center">
      <table width="415" border="0">
        <tr>
          <td height="58"><div align="center"><a href="editarMenuUser.php" class="button medium blue">Editar menu</a></div></td>
        </tr>
        <tr>
          <td><div align="center">
        ...
        <tr>
          <td><form id="form1" name="form1" method="get" action="../Templates/MenuPantalla/Menu2.php" target="_blank">
            <p align="center">
              <input type="submit" onclick="this.form.action = '../Templates/MenuPantalla/Menu.php'" name="button" id="button" value="Mostrar menu de pantalla 1" class="button medium blue" />
            </p>
            <p align="center">
              <input type="submit" onclick="this.form.action = '../Templates/MenuPantalla/Menu2.php'" name="button2" id="button2" value="Mostrar menu de pantalla 2" class="button medium blue" />
              <br />
