...
$query_menuHoy = sprintf("select platillo.nombre_plat, platillo.precio from	platillo, menu, detalle_menu  where menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s",GetSQLValueString($_GET['fecha'],"text"));;
...
<div class="container">
  ...
  <div class="content">
    ...
    <h1 align="center">El Menu de Hoy    </h1>
    <div align="center">
      <table width="478" border="1">
        ...
        <?php do { ?>
          <tr>
            ...
            <td><div align="center"><?php echo $row_menuHoy['precio']; ?></div></td>
          </tr>
