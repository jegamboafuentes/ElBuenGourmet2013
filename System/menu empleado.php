  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <div align="center">
      <table width="505" border="0">
        <tr>
          <td><div align="center"><a href="Templates/Empleados/Registro.php" class="button medium orange" >Nuevo empleado</a></div></td>
          <td><div align="center"><a href="Templates/Empleados/empleados.php" class="button medium orange">Empleados</a></div></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
