...
<html lang="es" dir="ltr">
	<head>
		<title>Menú de hoy - el buen GOURMET</title>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div id="imPage">
			<div id="imHeader">
				<h1 class="imHidden">Menú de hoy - el buen GOURMET</h1>
			...
			<div id="imContent">
				<a id="imGoToCont"></a>
				<h2 id="imPgTitle">Menú de hoy</h2>
				<div style="height: 15px;">&nbsp;</div>
				<div id="imFooPad" style="height: 350px; float: left;">&nbsp;</div>
				Este es el php 
				<div id="imBtMn"><a href="index.html">Página de inicio</a> | <a href="menu-de-hoy.html">Menú de hoy</a> | <a href="ordenar.html">Ordenar</a> | <a href="sobre-nosotros.html">Sobre nosotros</a> | <a href="loging.html">Loging</a> | <a href="imsitemap.html">Mapa general del sitio</a></div>				  
