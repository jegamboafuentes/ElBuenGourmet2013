  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <div align="center">
      <table width="415" border="0">
        <tr>
          <td><div align="center"><a target="_blank" href="Templates/Menu/Menu 2.0/Crear menu.php" class="button medium blue">Crear el menu de hoy</a></div></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><div align="center"><a target="_blank" href="Templates/Menu/Menu 2.0/Crear menu manana.php" class="button medium blue">Crear el menu de mañana</a></div></td>
        </tr>
        <tr>
          <td><div align="center"></div></td>
        </tr>
        <tr>
          <td height="58"><div align="center"><a href="Templates/Menu/Ver Menu.php" class="button medium blue">Ver / Editar menu</a></div></td>
        </tr>
        <tr>
          <td><div align="center">
