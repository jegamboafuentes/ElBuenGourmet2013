...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Menu de ventas por internet</p>
    <div align="center">
      <table width="200" border="0">
        <tr>
          <td><form id="form1" name="form1" method="get" action="Templates/Ventas/ventasHoy.php">
              <p align="center"><span style="color: #00F">Ventas de hoy
                </span>
                <input name="fecha" type="text" id="fecha" value="<?php echo date("d/m/Y"); ?>" size="11" readonly="readonly"/>
                <br />
        ...
        <tr>
          <td><form id="form2" name="form2" method="get" action="Templates/Ventas/ventasHoy.php">
              <div align="center"><span style="color: #00F">Ventas del dia</span><br />
                <span id="sprytextfield1">
                <input name="fecha" type="text" id="fecha2" value="--/--/----" size="11" />
