...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p align="center">Personas que tienen acceso al sistema.</p>
    <p>&nbsp;</p>
    <div align="center">
      <table width="385" border="0">
        <tr>
          <td><div align="center"><a href="Templates/Usuarios/registro.php" class="button medium pink" >Ingresar usuario</a></div></td>
          <td><div align="center"><a href="Templates/Usuarios/usuarios.php" class="button medium pink">Ver usuarios</a></div></td>
        </tr>
      </table>
    </div>
