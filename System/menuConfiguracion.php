...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Menu de configuraciones</p>
    <p>&nbsp;</p>
    <div align="center">
      <table width="306" border="0">
        <tr>
          <td><a href="Templates/Cod_pos/menu_cp.php" class="button medium green">Codigos postales </a></td>
          <td><a class="button medium green">Sucursales</a></td>
