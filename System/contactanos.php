...
<html lang="es" dir="ltr">
	<head>
		<title>Contactanos - el buen GOURMET</title>
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/contactanos.css" media="screen" />
	...
	<body>
		...
		<div id="imPage">
			<div id="imHeader">
				<h1 class="imHidden">Contactanos - el buen GOURMET</h1>
			...
			<div id="imContent">
				<a id="imGoToCont"></a>
				<h2 id="imPgTitle">Contactanos</h2>
				<div style="height: 15px;">&nbsp;</div>
				<div id="imFooPad" style="height: 350px; float: left;">&nbsp;</div>
				<div align="center">
				  <table width="843" border="1">
				    <tr>
				      <td><div align="center"><img src="Img/telefonos.JPG" width="490" height="266"></div></td>
			        </tr>
			      </table>
			  </div>
				<div id="imBtMn"><a href="home.html">Página de inicio</a> | <a href="menu-de-hoy.php">Menu de hoy</a> | <a href="ordenar.html">Ordenar</a> | <a href="ubicacion.html">Ubicacion</a> | <a href="contactanos.html">Contactanos</a> | <a href="sobre-nosotros.html">Sobre nosotros</a> | <a href="imsitemap.html">Mapa general del sitio</a></div>				  
