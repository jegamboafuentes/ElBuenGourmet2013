...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cliente (id_cliente, pass, nombre, apellido, telefono1, telefono2, calle, `no`, colonia, cp) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "Acceso.php?id=$idcliente";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/Plantilla Pedidos0.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div class="container">
  <div class="header"><a href="../index.php"><img src="../Img/logox.jpg" width="181" height="97" /></a><!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
      <li></li>
      <li><!-- end .sidebar1 --></li>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.<br />
          </span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*Repetir Correo Electronico</td>
          <td><span id="spryconfirm2">
            <label for="id_cliente"></label>
            <input name="id_clienteconfi" type="text" id="id_cliente" size="32" />
        ...
        <tr valign="baseline">
          ...
          <input type="password" name="pass" value="" size="32" id="pass" />
          <span class="passwordRequiredMsg">Se necesita un valor.</span><span class="passwordMinCharsMsg">Minimo 5 caracteres.</span></span><br />
          <label for="password3"></label>
          </span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*Repetir Password</td>
          <td><span id="spryconfirm1">
            <label for="pass"></label>
            <input name="passconfi" type="password" id="pass" size="32" />
          <span class="confirmRequiredMsg">Se necesita un valor.</span><span class="confirmInvalidMsg">Los valores no coinciden.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*Nombre:</td>
          <td><span id="spryNombre">
            <input type="text" name="nombre" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*Apellido:</td>
          <td><span id="spryApellido">
        ...
        <tr valign="baseline">
          ...
          <td><span id="spryTel1">
          <input type="text" name="telefono1" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><span id="sprycalle">
            <input type="text" name="calle" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*No:</td>
          <td><span id="spryNo">
            <input type="text" name="no" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*Colonia:</td>
          <td><span id="spryCol">
            <input type="text" name="colonia" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">*Cp:</td>
          <td><span id="spryCP">
          <input type="text" name="cp" value="" size="32" />
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprymail", "email", {validateOn:["blur"]});
var sprytextfield2 = new Spry.Widget.ValidationTextField("spryNombre");
var sprytextfield3 = new Spry.Widget.ValidationTextField("spryApellido");
var sprytextfield4 = new Spry.Widget.ValidationTextField("spryTel1", "none");
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprycalle");
var sprytextfield6 = new Spry.Widget.ValidationTextField("spryNo");
var sprytextfield7 = new Spry.Widget.ValidationTextField("spryCol");
var sprytextfield8 = new Spry.Widget.ValidationTextField("spryCP", "zip_code", {validateOn:["blur"]});
var spryconfirm2 = new Spry.Widget.ValidationConfirm("spryconfirm2", "id_cliente", {validateOn:["blur"]});
