...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "ordenes")) {
  $insertSQL = sprintf("INSERT INTO ordenes (id_cliente, fecha_ordenes, hora_ordenes) VALUES (%s, %s, %s)",
  ...
  <div class="content">
    ...
    <form id="ordenes" name="ordenes" method="POST" action="<?php echo $editFormAction; ?>">
      <p align="center">
        ...
        <br />
        Desea ordenar desde su direccion registrada?  ver direccion <br />
      </p>
      <div align="center">
    ...
    <form id="form2" name="form2" method="post" action="OrdenarNuevaDireccion.php?id=<?php echo $row_SeleccionaNombre['id_cliente']; ?>">
       <div align="center"> 
