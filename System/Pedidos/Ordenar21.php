...
if (isset($_GET['id_plat'])) {
  $colname_quiere = $_GET['id_plat'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_quiere = sprintf("SELECT nombre_plat FROM platillo WHERE id_plat = %s", GetSQLValueString($colname_quiere, "text"));
  ...
  <div class="content">
    ...
    <div align="center">
      <table width="422" border="0">
        <tr>
          <td><div align="center">Quieres agregar  <?php echo $row_quiere['nombre_plat']; ?>  al menu? <br />
            cuantas &lt;medida&gt;
              <input name="cantidad" type="text" id="cantidad" value="1" size="3" maxlength="2" />
            </div></td>
        </tr>
        <tr>
          <td><div align="center">
