...
$query_Recordset1 = sprintf("SELECT pass FROM cliente WHERE id_cliente = %s", GetSQLValueString($colname_Recordset1, "text"));
$Recordset1 = mysql_query($query_Recordset1, $COnexionGourmet) or die(mysql_error());
...
<div class="container">
  ...
  <div class="content">
    ...
    <?php 
			  ...
			  $mensaje = "  Tu contraseña es: ".$row_Recordset1['pass'];
			  if (mail($destino,$asunto,$mensaje,$desde)){
				echo "Contraseña enviada al correo electronico: ".$destino;  
			  } else {
    ...
    <form id="form1" name="form1" method="post" action="">
      ...
      <input name="textfield" type="hidden" id="textfield" value="<?php echo $row_Recordset1['pass']; ?>" />
    </form>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
