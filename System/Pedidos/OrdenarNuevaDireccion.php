...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "ordenes")) {
  $insertSQL = sprintf("INSERT INTO ordenes (id_cliente, fecha_ordenes, hora_ordenes, direcc_op) VALUES (%s, %s, %s, %s)",
  ...
  <div class="content">
    ...
    <form id="ordenes" name="ordenes" method="POST" action="<?php echo $editFormAction; ?>">
      <p align="center">
        ...
        <br />
        Ingresa la direccion a donde quieres que se te envie el pedido:
<br />
        <label for="direccion"></label>
        <textarea name="direccion" id="direccion" cols="70" rows="5"></textarea>
        <br />
        <input type="submit" name="si" id="Aceptar" value="Aceptar" />
      </p>
<input type="hidden" name="MM_insert" value="ordenes" />
    </form>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
