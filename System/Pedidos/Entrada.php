...
if (isset($_POST['email'])) {
  ...
  $MM_redirectLoginSuccess = "Acceso.php?id=$loginUsername";
  $MM_redirectLoginFailed = "Entrada.php";
...
<div class="container">
  ...
  <div class="content">
    ...
    <table width="538" border="0">
      <tr>
        <td width="275"><form id="Loging" name="Loging" method="POST" action="<?php echo $loginFormAction; ?>">
          <p>&nbsp;</p>
          <table width="200" border="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div align="right">
                <input type="submit" name="button" id="button" value="Accesar" />
              </div></td>
            </tr>
        </table>
          <a href="OlvidePass.php">Olvide mi contraseña</a>
          <p>&nbsp;</p>
        </form></td>
        <td width="247">Si aun no te has registrado para hacer tus pedidos, <a href="Registro.php">Registrate aqui.</a></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    <!-- InstanceEndEditable -->
