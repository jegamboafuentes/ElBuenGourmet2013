...
$query_Selecciona = "SELECT * FROM platillo";
$Selecciona = mysql_query($query_Selecciona, $COnexionGourmet) or die(mysql_error());
$row_Selecciona = mysql_fetch_assoc($Selecciona);
$totalRows_Selecciona = mysql_num_rows($Selecciona);

mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_agarraelid = "SELECT * FROM platillo";
$agarraelid = mysql_query($query_agarraelid, $COnexionGourmet) or die(mysql_error());
$row_agarraelid = mysql_fetch_assoc($agarraelid);
$totalRows_agarraelid = mysql_num_rows($agarraelid);
?>
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <p><a href="Crear Menu.php?id=<?php $valor ?>">seleccionar </a></p>
    <table border="1">
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td>precio</td>
        <td>tipo</td>
        <td>descripcion_plat</td>
        <td>imagen_plat</td>
      </tr>
      <?php do { ?>
          <tr>
            <td><form id="form1" name="form1" method="get" action="">
              <a href="Crear Menu.php?id=<?php echo $valor = $row_Selecciona['id_plat']; ?>">seleccionar </a>
              <input name="seleccion" type="radio" class="content" id="seleccion" value="<?php echo $valor ?>" />
              <label for="seleccion"></label>
            </form>
           <td><?php echo $row_Selecciona['id_plat']; ?></td>
          <td><?php echo $row_Selecciona['nombre_plat']; ?></td>
          <td><?php echo $row_Selecciona['precio']; ?></td>
          <td><?php echo $row_Selecciona['tipo']; ?></td>
          <td><?php echo $row_Selecciona['descripcion_plat']; ?></td>
          <td><?php echo $row_Selecciona['imagen_plat']; ?></td>
        </tr>
        <?php } while ($row_Selecciona = mysql_fetch_assoc($Selecciona)); ?>
    </table>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($Selecciona);

mysql_free_result($agarraelid);
?>
