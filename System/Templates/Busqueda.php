    ...
    <table border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><a href="modificarPlatillo.php?id=<?php echo $row_busqued['id_plat']; ?>"><img src="../Img/modif.png" alt="" width="35" height="35" /></a></td>
          <td><a href="elimina.php?id=<?php echo $row_busqued['id_plat']; ?>"><img src="../Img/eliminar-icono-4790-96.png" alt="" width="35" height="35" /></a></td>
        </tr>
