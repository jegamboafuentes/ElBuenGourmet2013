...
$query_empelados = "SELECT id_empleado, nombre, apellido FROM empleado where activo = 0";
$empelados = mysql_query($query_empelados, $COnexionGourmet) or die(mysql_error());
$row_empelados = mysql_fetch_assoc($empelados);
$totalRows_empelados = mysql_num_rows($empelados);
?>
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <div align="center">
      <table border="1">
        ...
        <?php do { ?>
          <tr>
            <td><div align="center"><?php echo $row_empelados['id_empleado']; ?></div></td>
            <td><div align="center"><?php echo $row_empelados['nombre']; ?></div></td>
            <td><div align="center"><?php echo $row_empelados['apellido']; ?></div></td>
            <td><a href="empleado detalle.php?id=<?php echo $row_empelados['id_empleado']; ?>" target="_blank"><img src="../../Img/Attach-icon.png" width="35" height="35" alt="Detalles" /></a></td>
            <td><a href="editar.php?id=<?php echo $row_empelados['id_empleado']; ?>"><img src="../../Img/modif.png" width="35" height="35" alt="Editar" /></a></td>
          </tr>
          <?php } while ($row_empelados = mysql_fetch_assoc($empelados)); ?>
      </table>
    </div>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center"><a href="empleadosinact.php">Empleados inactivos  </a></p>
