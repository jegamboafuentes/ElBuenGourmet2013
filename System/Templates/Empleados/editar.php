...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE empleado SET nombre=%s, apellido=%s, telefono1=%s, telefono2=%s, direccion=%s, sucursal=%s, puesto=%s, dias_laborales=%s, horaE=%s, horaS=%s, horaC=%s, fechainicio=%s, activo=%s WHERE id_empleado=%s",
                       ...
                       GetSQLValueString($_POST['dias_laborales'], "text"),
                       GetSQLValueString($_POST['horaE'], "text"),
                       GetSQLValueString($_POST['horaS'], "text"),
                       GetSQLValueString($_POST['horaC'], "text"),
...
$colname_Empleado = "-1";
if (isset($_GET['id'])) {
  $colname_Empleado = $_GET['id'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Empleado = sprintf("SELECT * FROM empleado WHERE id_empleado = %s", GetSQLValueString($colname_Empleado, "int"));
$Empleado = mysql_query($query_Empleado, $COnexionGourmet) or die(mysql_error());
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><?php echo $row_Empleado['id_empleado']; ?></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Nombre:</td>
          <td><span id="sprytextfield1">
            <input type="text" name="nombre" value="<?php echo htmlentities($row_Empleado['nombre'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Apellido:</td>
          <td><span id="sprytextfield2">
            <input type="text" name="apellido" value="<?php echo htmlentities($row_Empleado['apellido'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Telefono1:</td>
          <td><input type="text" name="telefono1" value="<?php echo htmlentities($row_Empleado['telefono1'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Telefono2:</td>
          <td><input type="text" name="telefono2" value="<?php echo htmlentities($row_Empleado['telefono2'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Direccion:</td>
          <td><span id="sprytextarea1">
            <textarea name="direccion" cols="50" rows="5"><?php echo htmlentities($row_Empleado['direccion'], ENT_COMPAT, 'utf-8'); ?></textarea>
          <span class="textareaRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Sucursal:</td>
          <td><span id="sprytextfield3">
            <input type="text" name="sucursal" value="<?php echo htmlentities($row_Empleado['sucursal'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Puesto:</td>
          <td><span id="sprytextfield4">
            <input type="text" name="puesto" value="<?php echo htmlentities($row_Empleado['puesto'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Dias laborales:</td>
          <td><input type="text" name="dias_laborales" value="<?php echo htmlentities($row_Empleado['dias_laborales'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Hora de entrada:</td>
          <td><input type="text" name="horaE" value="<?php echo htmlentities($row_Empleado['horaE'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Hora de salida:</td>
          <td><input type="text" name="horaS" value="<?php echo htmlentities($row_Empleado['horaS'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Hora de comida:</td>
          <td><input type="text" name="horaC" value="<?php echo htmlentities($row_Empleado['horaC'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Inicio de actividades:</td>
          <td><input type="text" name="fechainicio" value="<?php echo htmlentities($row_Empleado['fechainicio'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Activo:</td>
          <td><select name="activo">
            <option value="0" <?php if (!(strcmp(0, htmlentities($row_Empleado['activo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Si</option>
            <option value="1" <?php if (!(strcmp(1, htmlentities($row_Empleado['activo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
          </select></td>
        </tr>
        <tr valign="baseline">
