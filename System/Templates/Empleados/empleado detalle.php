...
$query_detalles = sprintf("SELECT * FROM empleado WHERE id_empleado = %s", GetSQLValueString($colname_detalles, "int"));
$detalles = mysql_query($query_detalles, $COnexionGourmet) or die(mysql_error());
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>&nbsp;<span class="container"><?php echo $row_detalles['nombre']; ?> <?php echo $row_detalles['apellido']; ?></span></p>
    <p>&nbsp;</p>
    <p>Telefono 1:<?php echo $row_detalles['telefono1']; ?></p>
    <p>Telefono 2: <?php echo $row_detalles['telefono2']; ?></p>
    <p>Direccion : <?php echo $row_detalles['direccion']; ?></p>
    <p>Sucursal : <?php echo $row_detalles['sucursal']; ?></p>
    <p>Puesto : <?php echo $row_detalles['puesto']; ?></p>
    <p>Dias laborales: <?php echo $row_detalles['dias_laborales']; ?></p>
    <p>Hora de entrada:&nbsp;<?php echo $row_detalles['horaE']; ?></p>
    <p>Hora de salida: <?php echo $row_detalles['horaS']; ?></p>
    <p>Hora de comida: <?php echo $row_detalles['horaC']; ?></p>
    <p>Inicio de actividades: <?php echo $row_detalles['fechainicio']; ?></p>
    <p>Activo:<?php if($row_detalles['activo']==0){echo "Si";} else {echo "No";} ?></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
