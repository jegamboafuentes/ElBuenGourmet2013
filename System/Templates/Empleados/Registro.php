...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO empleado (nombre, apellido, telefono1, telefono2, direccion, sucursal, puesto, dias_laborales, horaE, horaS, horaC, fechainicio) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
      ...
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><span id="sprytextfield3">
            <input type="text" name="sucursal" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Puesto:</td>
          <td><span id="sprytextfield4">
            <input type="text" name="puesto" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Dias laborales:</td>
          <td><textarea name="dias_laborales" cols="50" rows="5"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Hora de entrada:</td>
          <td><label for="horaE"></label>
          <input name="horaE" type="text" id="horaE" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Hora de salida:</td>
          <td><label for="horaS"></label>
          <input name="horaS" type="text" id="horaS" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Hora de comida:</td>
          <td><input type="text" name="horaC" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Inicio de actividades:</td>
          <td><label for="fechainicio"></label>
          <input name="fechainicio" type="text" id="fechainicio" size="32" /></td>
        </tr>
        <tr valign="baseline">
