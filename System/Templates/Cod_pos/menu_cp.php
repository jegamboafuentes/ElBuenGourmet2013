...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Configuracion de codigos postales</p>
    <p><a href="catalogo.php"></a></p>
    <p>&nbsp;</p>
    <div align="center">
      <table width="469" border="0">
        <tr>
          <td><div align="center"><a href="catalogo.php" class="button medium red">Ver catalogo de codigos postales</a></div></td>
          <td><div align="center"><a href="Ver_cp.php" class="button medium red">Administrar codigos postales</a></div></td>
        </tr>
      </table>
    </div>
    <p>&nbsp;</p>
