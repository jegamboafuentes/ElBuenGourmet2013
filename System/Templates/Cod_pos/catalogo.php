...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Catalogo de codigos postales</p>
    <p>&nbsp;</p>
    <div align="center">
      <table width="273" border="2">
        <tr>
          <td>Pachuca</td>
          <td><a href="../../Docs/codigos postales_pachuca.xlsx"><img src="../../Img/excel.png" width="35" height="35" alt="Ver catlogo" /></a></td>
        </tr>
        <tr>
