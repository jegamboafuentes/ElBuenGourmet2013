...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE cat_cp SET precio=%s, descripcion=%s WHERE cp=%s",
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_cp = sprintf("SELECT * FROM cat_cp WHERE cp = %s", GetSQLValueString($colname_cp, "text"));
$cp = mysql_query($query_cp, $COnexionGourmet) or die(mysql_error());
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Editar codigo postal    </p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Codigo postal:</td>
          <td><?php echo $row_cp['cp']; ?></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Precio:</td>
          <td><span id="sprytextfield1">
            <input type="text" name="precio" value="<?php echo htmlentities($row_cp['precio'], ENT_COMPAT, 'utf-8'); ?>" size="5" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Descripcion:</td>
          <td><span id="sprytextarea1">
            <textarea name="descripcion" cols="50" rows="5"><?php echo htmlentities($row_cp['descripcion'], ENT_COMPAT, 'utf-8'); ?></textarea>
      ...
      <input type="hidden" name="cp" value="<?php echo $row_cp['cp']; ?>" />
  </form>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
