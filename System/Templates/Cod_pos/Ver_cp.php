  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <div align="center">
      <table width="483" border="1">
        ...
        <?php do { ?>
          <tr>
            <td><div align="center"><?php echo $row_cp['cp']; ?></div></td>
            <td><div align="center"><?php echo $row_cp['precio']; ?></div></td>
            <td><div align="center"><?php echo $row_cp['descripcion']; ?></div></td>
            <td><div align="center"><a href="editar.php?cp=<?php echo $row_cp['cp']?>"><img src="../../Img/modif.png" width="35" height="35" /></a></div></td>
          </tr>
