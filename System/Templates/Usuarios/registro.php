...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usuarios (id_user, nombre, apellido, tipo, password) VALUES (%s, %s, %s, %s, %s)",
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <input type="text" name="id_user" size="32" />
        ...
        <tr valign="baseline">
          ...
          <td><select name="tipo">
            ...
            <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>Usuario</option>
          </select></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><span id="spryconfirm1">
            ...
            <input name="password2" type="password" id="password3" size="32" />
