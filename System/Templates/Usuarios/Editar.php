...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE usuarios SET nombre=%s, apellido=%s, tipo=%s WHERE id_user=%s",
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_usuarios = sprintf("SELECT id_user, nombre, apellido, tipo FROM usuarios WHERE id_user = %s", GetSQLValueString($colname_usuarios, "text"));
$usuarios = mysql_query($query_usuarios, $COnexionGourmet) or die(mysql_error());
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><?php echo $row_usuarios['id_user']; ?></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="apellido" value="<?php echo htmlentities($row_usuarios['apellido'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Tipo:</td>
          <td><select name="tipo">
            <option value="1" <?php if (!(strcmp(1, htmlentities($row_usuarios['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Administrador</option>
            <option value="2" <?php if (!(strcmp(2, htmlentities($row_usuarios['tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Usuario</option>
          </select></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="id_user" value="<?php echo $row_usuarios['id_user']; ?>" />
    </form>
    <p>&nbsp;</p>
