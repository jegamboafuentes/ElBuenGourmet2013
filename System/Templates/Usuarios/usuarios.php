...
$query_usuarios = "SELECT id_user, nombre, apellido, tipo FROM usuarios ORDER BY tipo ASC";
$usuarios = mysql_query($query_usuarios, $COnexionGourmet) or die(mysql_error());
$row_usuarios = mysql_fetch_assoc($usuarios);
$totalRows_usuarios = mysql_num_rows($usuarios);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="../Plantilla Admin.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
      ...
      <table border="1">
        ...
        <?php do { ?>
          <tr>
            ...
            <td><?php if($row_usuarios['tipo']==1){echo "Administrador";}else{echo "Usuario";}; ?></td>
            <td><a href="Editar.php?id=<?php echo $row_usuarios['id_user']; ?>"><img src="../../Img/modif.png" width="35" height="35" alt="Modificar" /></a></td>
            <td><a href="Elimina.php?id=<?php echo $row_usuarios['id_user']; ?>"><img src="../../Img/eliminar-icono-4790-96.png" width="35" height="35" alt="Eliminar" /></a></td>
          </tr>
