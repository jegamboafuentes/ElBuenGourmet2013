...
where 		detalle_ordenes.id_plat = platillo.id_plat and
			...
			platillo.id_plat = detalle_menu.id_plat and ordenes.id_ordenes = %s",
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Detalle de la orden : <a href="cliente.php?id=<?php echo $_GET['id']; ?>"><?php echo $_GET['id']; ?> </a></p>
    <div align="center">
      <table width="360" border="1">
        ...
        <?php do { ?>
          <tr class="cartTable">
            ...
            <?php $total = $total + ($row_detalle_menu['precio']*$row_detalle_menu['cantidad']); ?>
          </tr>
          <?php } while ($row_detalle_menu = mysql_fetch_assoc($detalle_menu)); ?>
      </table>
    </div>
    <p>&nbsp;</p>
    <p align="center">Total = <?php echo $total; ?></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
