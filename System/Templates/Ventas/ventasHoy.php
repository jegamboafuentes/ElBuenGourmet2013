...
$query_ordenes = sprintf("SELECT * FROM ordenes where fecha_ordenes = %s and subtotal is not null",GetSQLValueString($_GET['fecha'], "text"));
$ordenes = mysql_query($query_ordenes, $COnexionGourmet) or die(mysql_error());
...
<div class="container">
  ...
  <div align="center">
    ...
    <table border="1">
      ...
      <?php do { ?>
        <tr>
          <td><?php echo $row_ordenes['id_ordenes']; ?></td>
          <td><?php echo $row_ordenes['fecha_ordenes']; ?> | <?php echo $row_ordenes['hora_ordenes']; ?> </td>
          <td><a href="cliente.php?id=<?php echo $row_ordenes['id_ordenes']; ?>" target="_blank"><?php echo $row_ordenes['nombre']; ?> <?php echo $row_ordenes['apellido']; ?></a></td>
          <td><div align="center"><a  target="_blank" href="detalle.php?id=<?php echo $row_ordenes['id_ordenes']; ?>"><img src="../../Img/lista.png" width="35" height="35"/></a></div></td>
          <td><?php echo $row_ordenes['subtotal']; ?></td>
          <td><?php echo $row_ordenes['total']; ?></td>
          <?php $total = $total + $row_ordenes['subtotal']; ?>
          <?php $totaenvio = $totaenvio + $row_ordenes['total']; ?>
          </tr>
        <?php } while ($row_ordenes = mysql_fetch_assoc($ordenes)); ?>
    </table>
  </div>
  <p>&nbsp;</p>
  <p style="color: #333">Total del dia+envio $<?php echo $totaenvio?></p>
  <p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 250%;">Total del dia <span style="color: #F00">$<?php echo $total?></span></p>
  <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
