...
$colname_Datos = "-1";
if (isset($_GET['id'])) {
  $colname_Datos = $_GET['id'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_Datos = sprintf("SELECT nombre, apellido, tel, direccion, cod_postal, ciudad FROM ordenes WHERE id_ordenes = %s", GetSQLValueString($colname_Datos, "int"));
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>&nbsp;</p>
    <p><span style="font-family: 'Times New Roman', Times, serif; color: #333;">Nombre:</span> <?php echo $row_Datos['nombre']; ?><br />
      <span style="color: #333; font-family: 'Times New Roman', Times, serif;">Apellido:</span> <?php echo $row_Datos['apellido']; ?><br />
      <span style="font-family: 'Times New Roman', Times, serif; color: #333;">Telefono:</span> <?php echo $row_Datos['tel']; ?><br />
      <span style="color: #333; font-family: 'Times New Roman', Times, serif;">Direccion:</span> <?php echo $row_Datos['direccion']; ?><br />
      <span style="color: #333; font-family: 'Times New Roman', Times, serif;">CP:</span> <?php echo $row_Datos['cod_postal']; ?>  <br />
    </p>
    <p>&nbsp;</p>
