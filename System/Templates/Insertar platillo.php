...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO platillo (id_plat, nombre_plat, precio, tipo, descripcion_plat, especial) VALUES (%s, %s, %s, %s, %s, %s)",
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Insertar platillo:    </p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Clave:</td>
          <td><span id="sprytextfield1">
            <input type="text" name="id_plat" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Nombre:</td>
          <td><span id="sprytextfield2">
            <input type="text" name="nombre_plat" value="" size="32" />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><select name="tipo">
            <option value="Sopa" <?php if (!(strcmp("Sopa", ""))) {echo "SELECTED";} ?>>Sopa</option>
            <option value="Ensalada" <?php if (!(strcmp("Ensalada", ""))) {echo "SELECTED";} ?>>Ensalada</option>
            <option value="Antojito" <?php if (!(strcmp("Antojito", ""))) {echo "SELECTED";} ?>>Antojito</option>
            <option value="Guisado" <?php if (!(strcmp("Guisado", ""))) {echo "SELECTED";} ?>>Guisado</option>
