...
$query_TablaComidas = sprintf("SELECT case platillo.especial
                                      ...
                                      end as nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and platillo.tipo = 'Guisado' and menu.fecha = %s and menu.sucursal=%s",GetSQLValueString(date("d/m/Y"),"text"),GetSQLValueString($_GET['sucursal'],"text"));
...
$query_TablaBebidas = sprintf("SELECT  case platillo.especial
                                      when 1 then detalle_menu.nombre_especial
                                      when 0 then platillo.nombre_plat 
                                      end as nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s and platillo.tipo = 'Postre' and menu.sucursal=%s",GetSQLValueString(date("d/m/Y"),"text"),GetSQLValueString($_GET['sucursal'],"text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_TablaEnsaladas = sprintf("SELECT platillo.nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s and platillo.tipo = 'Antojito' ",GetSQLValueString(date("d/m/Y"),"text"));
        ...
        <table width="700" border="0">
          <tr>
            <td width="604" height="123"><div align="left">
              <table width="692" border="0">
                <tr>
                  <td style="font-family: 'Edwardian Script ITC'; color: #000; font-size: 900%;">Guisados:</td>
          ...
          <tr>
            <td height="123"><div align="left">
              <table width="692" border="0">
                <tr>
                  <td style="font-family: 'Edwardian Script ITC'; color: #000; font-size: 900%;">Postres:</td>
                  <td style="font-size: 700%; color: #000; font-family: 'Lucida Console', Monaco, monospace;"><div align="right">$</div></td>
                </tr>
              </table>
              <table width="692" border="0">
