...
$query_TablaComidas = sprintf("SELECT case platillo.especial
                                      when 1 then detalle_menu.nombre_especial
                                      when 0 then platillo.nombre_plat 
                                      end as nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and platillo.tipo = 'sopa' and menu.fecha = %s and menu.sucursal=%s",GetSQLValueString(date("d/m/Y"),"text"),GetSQLValueString($_GET['sucursal'],"text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_TablaBebidas = sprintf("SELECT case platillo.especial
                                      when 1 then detalle_menu.nombre_especial
                                      when 0 then platillo.nombre_plat 
                                      end as nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s and platillo.tipo = 'Ensalada' and menu.sucursal=%s",GetSQLValueString(date("d/m/Y"),"text"),GetSQLValueString($_GET['sucursal'],"text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_TablaEnsaladas = sprintf("SELECT case platillo.especial
                                      when 1 then detalle_menu.nombre_especial
                                      when 0 then platillo.nombre_plat 
                                      end as nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s and platillo.tipo = 'Antojito' and menu.sucursal=%s",GetSQLValueString(date("d/m/Y"),"text"),GetSQLValueString($_GET['sucursal'],"text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_TablaPostres = sprintf("SELECT platillo.nombre_plat, platillo.precio FROM platillo, menu, detalle_menu WHERE menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s and platillo.tipo = 'postre' ",GetSQLValueString(date("d/m/Y"),"text"));
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_TablaOtros = sprintf("select		platillo.nombre_plat, platillo.precio from		platillo, menu, detalle_menu  where menu.id_menu = detalle_menu.id_menu and detalle_menu.id_plat = platillo.id_plat and menu.fecha = %s and platillo.tipo = 'x' ",GetSQLValueString(date("d/m/Y"),"text"));
    ...
    <div>	
      <div align="center" >
        ...
        <table width="700" border="0">
          <tr>
            <td width="604" height="123"><div align="left">
              <table width="692" border="0">
                  <tr>
                    <td style="font-family: 'Edwardian Script ITC'; color: #000; font-size: 900%;">Sopas:</td>
                    <td style="font-size: 700%; color: #000; font-family: 'Lucida Console', Monaco, monospace;"><div align="right">$</div></td>
                  </tr>
                </table>
                <table width="692" border="0">
                  <?php do { ?>
          ...
          <tr>
            <td height="123"><div align="left">
              <table width="692" border="0">
                <tr>
                  <td style="font-family: 'Edwardian Script ITC'; color: #000; font-size: 900%;">Ensaladas:</td>
                  <td style="font-size: 700%; color: #000; font-family: 'Lucida Console', Monaco, monospace;"><div align="right">$</div></td>
                </tr>
            </table>
              <table width="692" border="0">
                <?php do { ?>
                <tr>
                  <td class="container1"><?php echo $row_TablaBebidas['nombre_plat']; ?></td>
                  <td width="344"><div align="right"><?php echo $row_TablaBebidas['precio']; ?></div></td>
                </tr>
          ...
          <tr>
            <td><div align="left">
              <table width="692" border="0">
                <tr>
                  <td style="font-family: 'Edwardian Script ITC'; color: #000; font-size: 900%;">Antojitos:</td>
                  <td style="font-size: 700%; color: #000; font-family: 'Lucida Console', Monaco, monospace;"><div align="right">$</div></td>
                </tr>
            </table>
              <table width="692" border="0">
                <?php do { ?>
                <tr>
                  <td class="container1"><?php echo $row_TablaEnsaladas['nombre_plat']; ?></td>
                  <td width="344"><div align="right"><?php echo $row_TablaEnsaladas['precio']; ?></div></td>
                </tr>
