...
<div class="container">
  ...
  <a href="../Pedidos/Acceso.php?id=<?php echo $colname_SeleccionaNombre;?>"><img src="../Img/logox.jpg" width="180" height="97" /></a>
...
<div>
  ...
  <div class="sidebar1">
    <ul class="nav">
      <li>Mi Perfil</li>
      <li><a href="../Pedidos/Ordenar.php?id=<?php echo $row_SeleccionaNombre['id_cliente']; ?>">Ordenar</a>  <!-- end .sidebar1 --></li>
    </ul>
  </div>
  <div class="content">
