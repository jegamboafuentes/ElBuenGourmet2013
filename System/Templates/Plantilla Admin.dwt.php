...
<div class="container">
  ...
  <div class="sidebar1">
    <div align="right">
      <ul class="nav">
        ...
        <li><a href="../menu usuarios.php">Usuarios <img src="../Img/icons/plate.png" width="32" height="32" /></a></li>
        <li><a href="../menu empleado.php">Empleados <img src="../Img/icons/chef-hat.png" width="32" height="32" /></a></li>
        ...
        <li><a href="../Menu Clientes.php">Clientes<img src="../Img/icons/lift.png" width="32" height="32" alt="clientes" /></a></li>
  ...
  <div class="content"><!-- end .content --><!-- TemplateBeginEditable name="EditRegion3" -->
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
