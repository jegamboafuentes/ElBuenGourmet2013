...
<title>Plantilla Asistente creacion menu</title>
<!-- TemplateEndEditable -->
...
<div class="container">
  ...
  <div class="content"><!-- TemplateBeginEditable name="BODY" -->
    <h1>&nbsp;</h1>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- TemplateBeginEditable name="left" --><!-- TemplateEndEditable --></div></td>
          <td width="606"><div align="center"><!-- TemplateBeginEditable name="center" --><!-- TemplateEndEditable --></div></td>
          <td width="129"><div align="right"><!-- TemplateBeginEditable name="right" --><!-- TemplateEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
