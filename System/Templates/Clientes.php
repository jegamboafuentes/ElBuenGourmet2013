...
$query_Clientes = "SELECT * FROM cliente ORDER BY nombre ASC";
    ...
    <table border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><a href="Detalles Cliente.php?id=<?php echo $row_Clientes['id_cliente'];?>">Detalles</a></td>
          <td><a href="EliminaCliente.php?id=<?php echo $row_Clientes['id_cliente'];?>">Eliminar</a></td>
        </tr>
