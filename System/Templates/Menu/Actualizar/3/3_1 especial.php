...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopa = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo='Antojito' ORDER BY CAST(id_plat as UNSIGNED)";
          ...
          <td rowspan="5"><table border="1">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="3_1.php?id=<?php echo $row_sopa['id_plat']; ?>&amp;id_menu=<?php echo $id_menu; ?>&amp;fecha=<?php echo $fecha; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" width="35" height="35" alt="Aceptar" /></a><a href="3_1.php?id=<?php echo $row_sopa['id_plat']; ?>&amp;id_menu=<?php echo $id_menu; ?>"></a></td>
                </tr>
