...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopa = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo='Postre' ORDER BY CAST(id_plat as UNSIGNED)";
...
<title>Editar los postres</title>
<!-- InstanceEndEditable -->
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Agregar postres al menu del dia: <?php echo $fecha = $_GET['fecha']; ?>
    ...
    <div align="center">
      <table width="663" border="0">
        <tr>
          <td><form id="Nombre" name="nombre" method="get" action="5 nombre.php">
          ...
          <td><form id="form2" name="form2" method="get" action="5 clave.php">
          ...
          <td rowspan="5"><table border="1">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="5_1.php?id=<?php echo $row_sopa['id_plat']; ?>&amp;id_menu=<?php echo $id_menu; ?>&amp;fecha=<?php echo $fecha; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" width="35" height="35" alt="Aceptar" /></a><a href="5_1.php?id=<?php echo $row_sopa['id_plat']; ?>&amp;id_menu=<?php echo $id_menu; ?>"></a></td>
                </tr>
