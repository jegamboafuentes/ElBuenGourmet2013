...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopa = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo='Sopa' ORDER BY CAST(id_plat as UNSIGNED)";
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_SopaActual = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre FROM platillo, detalle_menu WHERE detalle_menu.id_plat = platillo.id_plat and platillo.tipo='Sopa' and id_menu = %s ",GetSQLValueString($_GET['id_menu'], "text"));
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Agregar sopa al menu del dia: <?php echo $fecha = $_GET['fecha']; ?>
    ...
    <div align="center">
      <table width="663" border="0">
        <tr>
          <td><form id="Nombre" name="nombre" method="get" action="1 nombre.php">
          ...
          <td><form id="form2" name="form2" method="get" action="1 clave.php">
          ...
          <td rowspan="5"><table border="1">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="1_1.php?id=<?php echo $row_sopa['id_plat']; ?>&amp;id_menu=<?php echo $id_menu; ?>&amp;fecha=<?php echo $fecha; ?>"><img src="../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" width="35" height="35" alt="Aceptar" /></a><a href="1_1.php?id=<?php echo $row_sopa['id_plat']; ?>&id_menu=<?php echo $id_menu; ?>"></a></td>
                </tr>
