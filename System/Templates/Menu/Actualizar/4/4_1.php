...
if ($row_especial['especial'] == 1){header ("Location: 4_1 especial.php?id=".$_GET['id']."&id_menu=".$_GET['id_menu']."&fecha=".$_GET['fecha']);}
...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Agregar guisado al menu del dia: <?php echo $fecha = $_GET['fecha']; ?>
