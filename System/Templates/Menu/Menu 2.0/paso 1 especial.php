...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopas = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo = 'Sopa' ORDER BY CAST(id_plat as UNSIGNED)";
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_VerSopasAct = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre FROM platillo, detalle_menu WHERE detalle_menu.id_plat = platillo.id_plat and platillo.tipo='Sopa' and id_menu = %s ",GetSQLValueString($row_IdMenu_porFecha['id_menu'], "text"));;
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    <h1>Selecciona la sopa </h1>
    <table width="291" border="0" cellspacing="10">
      <tr>
        <td>Busqueda </td>
        <td>|<a href="paso 1 nombre.php">Nombre</a>| </td>
        <td>|<a href="paso 1 clave.php">Clave</a>|</td>
      </tr>
    </table>
    <div align="center">
         ...
         <tr>
           <td width="641"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             ...
             <p align="left">De que es
              ...
              <span class="textfieldRequiredMsg">Porfavor ingresa de que es la Sopa.</span></span> </p>
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 1.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="36" height="34" /></a></td>
                  </tr>
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="Paso 2/paso 2_0.php"><img src="../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><script type="text/javascript">
