...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <form action="paso 3 nombre buscado.php" method="get">
       Nombre :
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="../Paso 2/paso 2.php"><img src="../../../../Img/left.png" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
