...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopas = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo = 'Antojito' ORDER BY CAST(id_plat as UNSIGNED)";
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    <h1>Selecciona los antojitos</h1>
    <table width="291" border="0" cellspacing="10">
      <tr>
        <td>Busqueda </td>
        <td>|<a href="paso 3 nombre.php">Nombre</a>| </td>
        <td>|<a href="paso 3 clave.php">Clave</a>|</td>
      </tr>
    </table>
    <div align="center">
      <table width="879" border="0">
         <tr>
           <td width="641"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             ...
             <p align="left">Deseas agregar como antojito<?php echo $row_quiereplatillo['nombre_plat']; ?> al Menu ?
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 3.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="36" height="34" /></a></td>
                  </tr>
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="../Paso 2/paso 2.php"><img src="../../../../Img/left.png" alt="" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 4/paso 4_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><a href="../Paso 2/paso 2_0.php"></a><script type="text/javascript">
