...
$query_sopas = sprintf("SELECT id_plat, nombre_plat, precio FROM platillo WHERE tipo = 'Antojito' and nombre_plat LIKE %s", GetSQLValueString("%" . $colname_sopas . "%", "text"));
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <table width="200" border="0" cellspacing="10">
      <tr>
        <td>Busqueda </td>
        <td><a href="paso 3_0 nombre.php?nombre=">Nombre</a></td>
        <td><a href="paso 3_0 clave.php?clave=">Clave</a></td>
      </tr>
    </table>
    <form action="paso 3_0 nombre.php" method="get">
      nombre :
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="606"><div align="center"><!-- InstanceBeginEditable name="center" --><a href="../Rev.php" target="_blank"><img src="../../../../Img/ball.png" width="50" height="50" /></a><!-- InstanceEndEditable --></div></td>
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 4/paso 4_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><a href="../Paso 2/paso 2_0.php"></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
