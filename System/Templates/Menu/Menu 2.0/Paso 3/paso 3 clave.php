...
if ($row_especial['especial'] == 1){header ("Location: paso 3 especial.php?id=".$_GET['id']);}
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <form action="paso 3 clave buscado.php" method="get">
       Clave :
       ...
       <table width="879" border="0">
         <tr>
           <td width="670"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             ...
             <p align="left">Deseas agregar como antojitos<?php echo $row_quiereplatillo['nombre_plat']; ?> al Menu ?
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 3.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="35" height="35" /></a></td>
                 </tr>
