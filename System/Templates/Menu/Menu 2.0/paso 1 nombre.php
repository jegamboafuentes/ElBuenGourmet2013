...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <form action="paso 1 nombre buscado.php" method="get">
       Nombre :
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="Paso 2/paso 2_0.php"><img src="../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
