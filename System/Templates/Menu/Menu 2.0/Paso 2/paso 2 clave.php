...
if ($row_especial['especial'] == 1){header ("Location: paso 2 especial.php?id=".$_GET['id']);}
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <form action="paso 2 clave buscado.php" method="get">
       Clave :
       ...
       <table width="879" border="0">
         <tr>
           <td width="670"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             ...
             <p align="left">Deseas agregar como sopa <?php echo $row_quiereplatillo['nombre_plat']; ?> al Menu ?
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 2.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="35" height="35" /></a></td>
                 </tr>
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="../paso 1 link.php"><img src="../../../../Img/left.png" alt="" width="95" height="65" /></a><a href="../paso 1.php"></a><!-- InstanceEndEditable --></div></td>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 3/paso 3_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><a href="paso 3_0.php"></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
