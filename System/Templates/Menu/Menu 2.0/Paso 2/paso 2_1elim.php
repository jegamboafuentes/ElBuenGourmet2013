      ...
      <table width="879" border="0">
         <tr>
           <td width="670"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             ...
             <p align="left"><?php echo $row_quiereplatillo['nombre_plat']; ?> se elimino del menu</p>
             <p align="left">
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 3/paso 3_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><a href="paso 3_0.php"></a><a href="paso 2_0.php"></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
