...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopas = sprintf("SELECT id_plat, nombre_plat, precio FROM platillo WHERE tipo='Ensalada' and id_plat = %s", GetSQLValueString($colname_sopas, "text"));
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="../paso 1 link.php"><img src="../../../../Img/left.png" alt="" width="95" height="65" /></a><a href="../paso 1.php" target="_blank"></a><!-- InstanceEndEditable --></div></td>
