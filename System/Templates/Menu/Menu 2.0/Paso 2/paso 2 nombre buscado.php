...
if (isset($_GET['nombre'])) {
  $colname_sopas = $_GET['nombre'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopas = sprintf("SELECT id_plat, nombre_plat, precio FROM platillo WHERE tipo = 'Ensalada' and nombre_plat LIKE %s", GetSQLValueString("%" . $colname_sopas . "%", "text"));
