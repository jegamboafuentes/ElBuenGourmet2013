...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopas = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo = 'Ensalada' ORDER BY CAST(id_plat as UNSIGNED)";
...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_VerSopasAct = sprintf("SELECT platillo.id_plat,detalle_menu.id_menu, case platillo.especial when 1 then detalle_menu.nombre_especial when 0 then platillo.nombre_plat  end as nombre FROM platillo, detalle_menu WHERE detalle_menu.id_plat = platillo.id_plat and platillo.tipo='Ensalada' and id_menu = %s ",GetSQLValueString($row_IdMenu_porFecha['id_menu'], "text"));;
...
//if ($row_especial['especial'] == 1){header ("Location: paso 1 especial.php?id=".$_GET['id']);}
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    <h1>Selecciona la ensalada</h1>
    <table width="291" border="0" cellspacing="10">
      <tr>
        <td>Busqueda </td>
        <td>|<a href="paso 2 nombre.php">Nombre</a>| </td>
        <td>|<a href="paso 2 clave.php">Clave</a>|</td>
      </tr>
    </table>
    <div align="center">
      <table width="879" border="0">
         <tr>
           <td width="641"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             <p align="left">
             ...
             <p align="left">Deseas agregar como ensalada <?php echo $row_quiereplatillo['nombre_plat']; ?> al Menu ?
               <input type="submit" name="button" id="button" value="Ok" />
              </p>
             <p align="left">De que es
               <?php echo $row_quiereplatillo['nombre_plat']; ?>? 
               
               <span id="sprytextfield1">
               <input type="text" name="especifico" id="especifico" />
              <span class="textfieldRequiredMsg">Porfavor ingresa de que es la ensalada.</span></span> </p>
             <label for="especifico"></label>
             <p align="left">
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 2.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="36" height="34" /></a></td>
                  </tr>
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="606"><div align="center"><!-- InstanceBeginEditable name="center" --><a href="../Rev.php" target="_blank"><img src="../../../../Img/ball.png" width="50" height="51" alt="Menu hasta ahora" /></a><!-- InstanceEndEditable --></div></td>
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 3/paso 3_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><script type="text/javascript">
