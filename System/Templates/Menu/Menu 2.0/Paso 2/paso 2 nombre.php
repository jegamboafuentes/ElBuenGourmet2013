...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <form action="paso 2 nombre buscado.php" method="get">
       Nombre :
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="../paso 1 link.php"><img src="../../../../Img/left.png" alt="" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 3/paso 3_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
