...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_sopas = "SELECT id_plat, nombre_plat, precio FROM platillo where tipo = 'Postre' ORDER BY CAST(id_plat as UNSIGNED)";
      ...
      <table width="879" border="0">
         <tr>
           <td width="641"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="post">
             ...
             <p align="left">Deseas agregar como postre <?php echo $row_quiereplatillo['nombre_plat']; ?> al Menu ?
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 5.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="36" height="34" /></a></td>
                  </tr>
  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="../Paso 4/paso 4 link.php"><img src="../../../../Img/left.png" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Fin.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><script type="text/javascript">
