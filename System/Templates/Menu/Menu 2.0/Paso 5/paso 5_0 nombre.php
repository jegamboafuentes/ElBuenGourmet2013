...
$query_sopas = sprintf("SELECT id_plat, nombre_plat, precio FROM platillo WHERE tipo = 'Postre' and nombre_plat LIKE %s", GetSQLValueString("%" . $colname_sopas . "%", "text"));
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="BODY" -->
    ...
    <table width="200" border="0" cellspacing="10">
      <tr>
        <td>Busqueda </td>
        <td><a href="paso 5_0 nombre.php?nombre=">Nombre</a></td>
        <td><a href="paso 5_0 clave.php?clave=">Clave</a></td>
      </tr>
    </table>
    <form action="paso 5_0 nombre.php" method="get">
      nombre :
