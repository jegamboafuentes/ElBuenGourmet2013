    ...
    <h1>Selecciona el guisado</h1>
     <table width="200" border="0" cellspacing="10">
      <tr>
        ...
        <td><a href="paso 4_0 clave.php">Clave</a></td>
      </tr>
    </table>
     <p>&nbsp;</p>
     <div align="center">
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 5/paso 5_0.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
