...
if ($row_especial['especial'] == 1){header ("Location: paso 4 especial.php?id=".$_GET['id']);}
             ...
             <table border="1">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td><a href="paso 4.php?id=<?php echo $row_sopas['id_plat']; ?>"><img src="../../../../Img/aceptar-este-hecho-tan-bien-verde-con-exito-icono-8880-96.png" alt="" width="35" height="35" /></a></td>
                 </tr>
    ...
    <div align="center">
      <table width="874" border="0">
        <tr>
          ...
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../Paso 5/paso 5 link.php"><img src="../../../../Img/right.png" alt="Derecha" width="95" height="65" /></a><a href="../Paso 2/paso 2_0.php"></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
