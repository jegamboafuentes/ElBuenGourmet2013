...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_ultimafecha = sprintf("SELECT fecha FROM menu where fecha = %s",GetSQLValueString(date("d/m/Y"),"text"));
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="fecha" value="<?php echo date("d/m/Y"); ?>" size="32" readonly="readonly" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
          <td><input type="<?php if($row_ultimafecha['fecha']==date("d/m/Y")){echo "hidden";}else {echo "submit";}?>" value="Insertar registro" /></td>
        </tr>
      </table>
      <input type="hidden" name="MM_insert" value="form1" />
      <input name="ultimafecha" type="hidden" id="ultimafecha" value="<?php echo $row_ultimafecha['fecha']; ?>" />
    </form>
    <form id="form3" name="form3" method="post" action="../Actualizar/Editar Menu.php?fecha=<?php echo date("d/m/Y");?>" style="<?php if($row_ultimafecha['fecha']!=date("d/m/Y")){echo "display:none";}else {echo "display:block";}?>" >
