  ...
  <div class="footer">
    <div align="center">
      <table width="874" border="0">
        <tr>
          <td width="117"><div align="left"><!-- InstanceBeginEditable name="left" --><a href="Paso 5/paso 5 link.php"><img src="../../../Img/left.png" alt="Paso 5" width="95" height="65" /></a><!-- InstanceEndEditable --></div></td>
          <td width="606"><div align="center"><!-- InstanceBeginEditable name="center" --><!-- InstanceEndEditable --></div></td>
          <td width="129"><div align="right"><!-- InstanceBeginEditable name="right" --><a href="../../../Menumenu.php"><img src="../../../Img/finish.png" width="65" height="65" alt="Finalizar" /></a><!-- InstanceEndEditable --></div></td>
        </tr>
      </table>
    </div>
  </div>
