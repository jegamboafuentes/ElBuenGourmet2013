...
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_verplatillos = "SELECT id_plat, nombre_plat, precio, tipo FROM platillo";
...
<div>
  <div class="header"><img src="../../Img/logox.jpg" width="244" height="125" /><!-- end .header -->
  <a href="../../Menumenu.php">Termine de seleccionar los platillos</a></div>
  <div class="content">
    ...
    <p> Buscar por <a href="Seleccionar Platillo.php">Nombre</a></p>
    <form id="form2" name="form2" method="GET" action="Seleccionar PlatilloBusquedaTipo.php">
      <label for="busqueda">
      Buscar</label>
...
<input type="submit" name="button2" id="button2" value="Enviar" />
    ...
    <table width="1311" border="0">
      <tr>
        <th width="880" rowspan="90" nowrap="nowrap">&nbsp;
          <table border="1">
            <tr>
        ...
        <td width="415">&nbsp;El Menu de hoy es:
          <table width="98%" height="74" border="1" class="container">
            <tr>
              <td>Id Platillo</td>
              <td>Menu</td>
              <td>Platillo</td>
            ...
            <?php do { ?>
              <tr>
                <td><?php echo $row_detalle_menu['id_plat'];?>
                <td><?php echo $row_detalle_menu['id_menu']; ?></td>
                <td><?php echo $row_detalle_menu['nombre_plat']; ?></td>
                <td><a href="EliminaPlatilloMenu.php?id_plat=<?php echo $row_detalle_menu['id_plat']; ?>&id_menu=<?php echo                                                                   $row_detalle_menu['id_menu']; ?></h6>">Eliminar</a></td>
              </tr>
