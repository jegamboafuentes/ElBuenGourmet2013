  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <div align="center">
      <table width="200" border="0">
        <tr>
          <td><form id="Menu hoy" name="Menu hoy" method="get" action="Actualizar/Editar Menu.php">
        ...
        <tr>
          <td><form id="fecha" name="fecha" method="get" action="Actualizar/Editar Menu.php">
            <label for="fecha"></label>
            <input type="text" name="fecha" id="fecha" value="<?php echo $dia_manana."/".$mes_manana."/".$ano_manana ; ?>" readonly="readonly" />
            <br />
            <input type="submit" name="button3" id="button3" value="Menu mañana" class="button medium yellow" />
            <br />
          </form></td>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          <td><form id="Menu fecha" name="Menu fecha" method="get" action="Actualizar/Editar Menu.php">
            <label for="fecha"></label>
            ...
            <input type="submit" name="button4" id="button4" value="Fecha" class="button medium yellow" />
            <br />
          </form></td>
          <td>&nbsp;</td>
        </tr>
