...
if (isset($_GET['tipo'])) {
  $colname_verplatillos = $_GET['tipo'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_verplatillos = sprintf("SELECT id_plat, nombre_plat, precio, tipo FROM platillo WHERE tipo = %s", GetSQLValueString($colname_verplatillos, "text"));
