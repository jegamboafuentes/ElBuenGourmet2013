...
<div class="container">
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    <p>Menu de la fecha: <?php echo $fecha = $_GET['fecha']; ?> </p>
    <p>&nbsp;</p>
    <p align="center"><a href="Menuporfecha/MenuporfechaEdit.php?id_plat=<?php echo $row_VerMenuHoy['id_plat']; ?>&id_menu=<?php echo                                                                   $row_VerMenuHoy['id_menu']; ?>&fecha=<?php echo                                                                   $fecha; ?>">Añadir platillo</a></p>
    <div align="center">
      <table border="1">
        <tr>
          <td>Id menu</td>
        ...
        <?php do { ?>
          <tr>
            ...
            <td><a href="EliminaMenuPorFecha.php?id_plat=<?php echo $row_VerMenuHoy['id_plat']; ?>&id_menu=<?php echo                                                                   $row_VerMenuHoy['id_menu']; ?>&fecha=<?php echo                                                                   $fecha; ?>">Quitar</a></td>
          </tr>
