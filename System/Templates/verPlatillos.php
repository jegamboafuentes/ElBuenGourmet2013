...
$query_recordsetPlatillos = "SELECT id_plat, nombre_plat, precio, tipo, descripcion_plat, especial FROM platillo ORDER BY CAST(id_plat as UNSIGNED)";
  ...
  <div class="content"><!-- end .content --><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <div align="left">
      <table width="592" border="0">
        <tr>
          <td><form action="Busqueda.php" method="get">
            Nombre:
                <input type="text" name="nombre" />
            <input type="submit" value="OK" />
            <br />
          </form></td>
          <td><form id="clave" name="clave" method="get" action="Busquedaclave.php">
    ...
    <table border="1" align="center">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><h6><?php if ($row_recordsetPlatillos['especial']==0){echo "No";}else{echo "Si";}; ?></h6></td>
          <td><a href="modificarPlatillo.php?id=<?php echo $row_recordsetPlatillos['id_plat']; ?>"><img src="../Img/modif.png" alt="" width="35" height="35" /></a></td>
          <td><a href="elimina.php?id=<?php echo $row_recordsetPlatillos['id_plat']; ?>"><img src="../Img/eliminar-icono-4790-96.png" alt="" width="35" height="35" /></a></td>
        </tr>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($recordsetPlatillos);
?>
