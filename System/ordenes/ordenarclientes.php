...
if (isset($_GET['id_cliente'])) {
  $colname_clientes = $_GET['id_cliente'];
}
mysql_select_db($database_COnexionGourmet, $COnexionGourmet);
$query_clientes = sprintf("SELECT * FROM cliente WHERE id_cliente = %s", GetSQLValueString($colname_clientes, "text"));
$clientes = mysql_query($query_clientes, $COnexionGourmet) or die(mysql_error());
                    ...
                    <table align="center">
                      ...
                      <tr valign="baseline">
                        ...
                        <td><span id="sprytextfield1">
                          <input type="text" name="nombre" value="<?php echo $row_clientes['nombre']; ?>" size="32">
                      ...
                      <tr valign="baseline">
                        ...
                        <td><span id="sprytextfield2">
                          <input type="text" name="apellido" value="<?php echo $row_clientes['apellido']; ?>" size="32">
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr valign="baseline">
                        ...
                        <td><span id="sprytextfield3">
                          <input type="text" name="tel" value="<?php echo $row_clientes['tel']; ?>" size="32">
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr valign="baseline">
                        ...
                        <td><span id="sprytextarea1">
                          <textarea name="direccion" cols="50" rows="5"><?php echo $row_clientes['direccion']; ?></textarea>
                      ...
                      <tr valign="baseline">
                        ...
                        <input type="text" name="cod_postal" value="<?php echo $row_clientes['cod_postal']; ?>" size="5">
                      ...
                      <tr valign="baseline">
                        ...
                        <td><select name="ciudad">
                          <option value="Pachuca"  <?php if (!(strcmp("Pachuca", $row_clientes['ciudad']))) {echo "selected=\"selected\"";} ?>>Pachuca</option>
                          <?php
do {  
?>
                          <option value="<?php echo $row_clientes['ciudad']?>"<?php if (!(strcmp($row_clientes['ciudad'], $row_clientes['ciudad']))) {echo "selected=\"selected\"";} ?>><?php echo $row_clientes['ciudad']?></option>
                          <?php
